...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setDocumentTitle("World Clock Report"); // Title of report
		sparkReporter.config().setReportName("World Clock"); // name of the report
		...
		extent.setSystemInfo("Sub Module", "OneCognizant");
